...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Evidence-based integrative medicine, longevity, and preventive care led by Dr. Jason Chen. Serving Colorado, Washington, and via telehealth." },
