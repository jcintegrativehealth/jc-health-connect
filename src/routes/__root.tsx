...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "JC Integrative Health — Integrative Medicine & Longevity" },
      { name: "description", content: "Personalized, evidence-based integrative medicine, longevity, and preventive care. Serving Virginia, Maryland, Colorado, and via telehealth." },
      { name: "author", content: "JC Integrative Health" },
      { name: "theme-color", content: "#0D1B2A" },
      { property: "og:site_name", content: "JC Integrative Health" },
      { property: "og:title", content: "JC Integrative Health — Integrative Medicine & Longevity" },
      { property: "og:description", content: "Personalized, evidence-based integrative medicine, longevity, and preventive care. Serving Virginia, Maryland, Colorado, and via telehealth." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "JC Integrative Health — Integrative Medicine & Longevity" },
      { name: "twitter:description", content: "Personalized, evidence-based integrative medicine, longevity, and preventive care. Serving Virginia, Maryland, Colorado, and via telehealth." },
