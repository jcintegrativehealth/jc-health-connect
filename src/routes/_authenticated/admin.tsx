...
import { Copy, Check, Loader2, AlertCircle, ExternalLink, Shield, Clock, LogOut } from "lucide-react";
...
function AdminFooter() {
  ...
  return (
    <footer className="border-t border-navy/8 mt-12 py-5 px-5 md:px-10 flex flex-col md:flex-row justify-between gap-2 text-[11px] uppercase tracking-widest text-navy/40">
      ...
      <span className="text-gold/80">Secure console — authenticated, role-based access</span>
    </footer>
  );
}
